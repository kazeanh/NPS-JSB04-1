...
user.surname = "Xuan";
user.name = "Cafedev";
// nếu như nó chưa tồn tại key name thì sẽ thêm mới vào,
// nếu như đã tồn tại key name => update
delete user.name;
...
let obj = {
  // name: "Hieu",
  // age: 24,
  // address: ["LLQ","Tay Ho", "Ha Noi"]
}

function isEmpty(obj) {
  // for .. in .. obj: vong  for duyệt các phần tử trong obj
  for (let key in obj) {
    // if the loop has started, there is a property
    return false;
    // khi chạy xong lệnh return => ta kết thúc luôn hàm
  }
  return true;
}
...
Ở đây giá trị của bên trong makeUser() này là undefined, bởi vì nó được gọi dưới dạng một hàm,
không phải là một phương thức với cú pháp “dot”.
